        ...
        <table id="example" class="table table-striped table-bordered" style="width:100%">
            ...
            <div class="row intro">
                <div class="col-lg-6 col-12 text-center">
                    ...
                    @for ($i = 0; $i < 1; $i++) <img src="{{asset($product->imagenes[$i]->url)}}" alt="adasd.jpeg"
                        width="150">
                        @endfor
                        @endif
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col float-right align-self-end">
                        ...
                        {{Form::submit('mas detalles', ['class' => 'btn btn-primary mb-5'])}}{{--debe de ser mas detalles, haciendo prueba para vista ganadora--}}
